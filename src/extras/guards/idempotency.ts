...
import type { Cache } from "../adapters/cache.port.js";

const PENDING_TTL = 60; // an in-flight request should resolve well within this
const DONE_TTL = 24 * 60 * 60; // replay a completed response for 24h
